...
import unsw.Infs3634.HealthyEat.R;
...
public class RecipeActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appBarTxt.setText("Healthy Eat Step by Step");

        Log.d(TAG, "onCreate: starts");

        final String[] topicHeadingLevelOneArray = {
                "Recipe 1: Fitness Protein Meal",
                "Recipe 2: Nutty Cheat Day",
                "Recipe 3: Veggie Fantasy",
                "Recipe 4: Meat Lover",
                "Recipe 5: Sunshine in the morning",

        };

        final String[] topicHeadingLevelTwoArray = {
                "High-Protein Recipe for Fitness People",
                "Time to grab a piece of CAKE",
                "Prob the best Salad Recipe in the world ",
                "Did someone just say Golden Ramsay? ",
                "Who need Boost when you can make better juice at home",
        ...
        RecipeAdapter newRecipeAdapter = new RecipeAdapter(this, topicHeadingLevelOneArray, topicHeadingLevelTwoArray, topicContent);
